...
public class PanelGestionTests
{
    ...
    public void CrearFactura_ValidarCamposYVerificarAlReabrir()
    {
        ...
        // 7. Datos de prueba
        string numeroFactura = $"FACT_AUTO_{DateTime.Now:yyyyMMdd}"; // Ejemplo: FACT_AUTO_20250830
        string codigoProveedor = "1102"; // Ajusta a un proveedor válido
        string moneda = "010"; // Ajusta
        ...
        string cvtaProveedor = "FCA CORDOBA"; // Valor esperado para validar
        string importeFOB = "100.0000"; // Formato con 4 decimales
