...
namespace Comex.Test.Automatizacion.Pages
{
    ...
    public class FacturaPageFCA
    {
        private readonly IWebDriver driver;

        public FacturaPageFCA(IWebDriver driver) => this.driver = driver;
       ...
       // private IWebElement ProfitCenter => driver.FindElement(By.Id("CphContenido_ddlProfitCenter"));
        ...
        public void CompletarDatosFacturaFCA(string nroFactura, string proveedor, string cliente, string moneda, string condicion, /*string profit, string centroCosto,*/ string fecha)
        {
            NroFactura.SendKeys(nroFactura);
            Proveedor.SendKeys(proveedor);
            ClienteInterno.Click();
        ...
        public void Guardar() => BtnGuardar.SendKeys(Keys.Enter);
